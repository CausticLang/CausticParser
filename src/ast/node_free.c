...
void cst_free_node(struct cst_NodeBase* node) {
    ...
    switch (node->type) {
        ...
        case IfStmt: case ElIfStmt: case ElseStmt: case ForStmt: case WhileStmt: case PassStmt: case FlowControlStmt: case ReturnStmt: case Declaration: case Assignment:
